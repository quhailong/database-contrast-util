...
public class PrimaryDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "top.quhailong.database.dao.primary";

    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "top/quhailong/database/dao/primary/mapper/*.xml";
